    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type == "signup"? <LabelledInput label="Name" placeholder="Gayathri Chinda" /> : null}

                    <LabelledInput label="Username" placeholder="gayathrichinda54@gmail.com"/>

                    <LabelledInput label="password" type= {"password"} placeholder="123456" />
                    <button onClick={handleClick} type="button" className="mt-8 w-full text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4
